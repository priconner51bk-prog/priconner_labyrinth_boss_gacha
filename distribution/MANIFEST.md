...
生成物: `distribution/priconner_labyrinth_boss_gacha_gacha_minimal_20260914_v9.zip`
...
旧v3/v4/v5/v6/v7/v8 ZIPは使用しない。v9はガチャ経路に必要な設定参照とテンプレートが一致し、削除済みL03経路を含まないことを検査済み。
